...
resource "null_resource" "setup_kali" {
    provisioner "local-exec" {
        command = "ssh -o \"StrictHostKeyChecking no\" -i ~/.ssh/id_rsa kali@${azurerm_linux_virtual_machine.kali_machine.public_ip_address} < setup_kali.sh"
    }
}
