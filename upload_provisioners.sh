...
az storage blob upload --account-name $ACCOUNT_NAME --name active_directory_provision.ps1 --type block --file active_directory_provision.ps1 --container-name $CONTAINER_NAME --overwrite
